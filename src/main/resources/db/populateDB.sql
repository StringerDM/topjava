...
VALUES ('2020-01-30 10:00:00', 'Завтрак - user', 500, 100000),
       ...
       ('2020-01-30 10:00:00', 'Завтрак - admin', 500, 100001),
       ('2020-01-30 13:00:00', 'Обед - admin', 1000, 100001),
       ('2020-01-30 20:00:00', 'Ужин - admin', 500, 100001),
       ('2020-01-31 00:00:00', 'Еда на граничное значение - admin', 100, 100001),
       ('2020-01-31 10:00:00', 'Завтрак - admin', 1000, 100001),
       ('2020-01-31 13:00:00', 'Обед - admin', 500, 100001),
       ('2020-01-31 20:00:00', 'Ужин - admin', 410, 100001)